"""
Tratamento e consolidação inicial das bases do desafio de BI. Envolve a descoberta e prova das hipóteses e pontos relevantes visualizados anteriormente.
